...
print()
print("""03. Write a function called add_all_nums which takes arbitrary number 
...
print()
print("""07. Quadratic equation is calculated as follows: ax² + bx + c = 0. 
...
print()
print("03. Call your function is_empty, it takes a parameter and it checks if it is empty or not")
